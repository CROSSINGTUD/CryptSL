...
public class CrySLTemplateFileInfo extends TemplateFileInfo{

	private String cryptoClassName;
	
	public CrySLTemplateFileInfo(String folder, String name, String cryptoClassName, AbstractFileTemplate template) {
