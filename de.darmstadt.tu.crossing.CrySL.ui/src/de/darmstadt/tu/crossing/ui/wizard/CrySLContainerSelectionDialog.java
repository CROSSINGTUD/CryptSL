...
public class CrySLContainerSelectionDialog extends SelectionDialog {
	/**
	 * mirrored from 
	...
	// the widget group;
	CrySLContainerSelectionGroup group;
	 ...
	 * {@inheritDoc}
	 */
	public CrySLContainerSelectionDialog(Shell parentShell, IContainer initialRoot, boolean allowNewContainerName,
			String message) {
		super(parentShell);
	 ...
	 *      ContainerSelectionGroup is changed to CrySLContainerSelectionGroup to restrict the user to just select "src"
	...
	protected Control createDialogArea(Composite parent) {
		...
		group = new CrySLContainerSelectionGroup(area, listener, allowNewContainerName, getMessage(),
				showClosedProjects);
