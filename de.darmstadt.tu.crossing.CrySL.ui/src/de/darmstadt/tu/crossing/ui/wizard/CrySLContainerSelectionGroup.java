...
public class CrySLContainerSelectionGroup extends ContainerSelectionGroup {
	...
	public CrySLContainerSelectionGroup(Composite parent, Listener listener, boolean allowNewContainerName,
	 ...
	 * @see de.darmstadt.tu.crossing.ui.wizard.CrySLTreeViewer
	 * @see de.darmstadt.tu.crossing.ui.CrySLDrillDownComposite
	 * 
	 */
	@Override
	protected void createTreeViewer(int heightHint) {
		// Create drill down.
		CrySLDrillDownComposite drillDown = new CrySLDrillDownComposite(this, SWT.BORDER);
		...
		treeViewer = new CrySLTreeViewer(drillDown, SWT.NONE);
