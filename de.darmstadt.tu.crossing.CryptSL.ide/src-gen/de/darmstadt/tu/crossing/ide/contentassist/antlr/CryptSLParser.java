		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getConstraintAccess().getConsAssignment_2(), "rule__Constraint__ConsAssignment_2");
					put(grammarAccess.getInclAccess().getAlglAssignment_0(), "rule__Incl__AlglAssignment_0");
					put(grammarAccess.getInclAccess().getLitsleftAssignment_3(), "rule__Incl__LitsleftAssignment_3");
					put(grammarAccess.getInclAccess().getAlgrAssignment_6(), "rule__Incl__AlgrAssignment_6");
					put(grammarAccess.getInclAccess().getLitsrightAssignment_9(), "rule__Incl__LitsrightAssignment_9");
