		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getLogConAccess().getAlternatives(), "rule__LogCon__Alternatives");
					put(grammarAccess.getConsAccess().getAlternatives(), "rule__Cons__Alternatives");
					put(grammarAccess.getNoEqAccess().getAlternatives(), "rule__NoEq__Alternatives");
					put(grammarAccess.getNoEqAccess().getAlternatives_1_2(), "rule__NoEq__Alternatives_1_2");
					put(grammarAccess.getNoEqAccess().getAlternatives_2_0(), "rule__NoEq__Alternatives_2_0");
					put(grammarAccess.getLitListAccess().getAlternatives_1_1(), "rule__LitList__Alternatives_1_1");
					put(grammarAccess.getCompAccess().getAlternatives_0(), "rule__Comp__Alternatives_0");
					put(grammarAccess.getCompAccess().getAlternatives_0_1_2(), "rule__Comp__Alternatives_0_1_2");
					put(grammarAccess.getCompAccess().getAlternatives_0_2_0(), "rule__Comp__Alternatives_0_2_0");
					...
					put(grammarAccess.getForbMethodAccess().getGroup_1_2(), "rule__ForbMethod__Group_1_2__0");
					put(grammarAccess.getForbMethodAccess().getGroup_1_2_2(), "rule__ForbMethod__Group_1_2_2__0");
					put(grammarAccess.getForbMethodAccess().getGroup_1_4(), "rule__ForbMethod__Group_1_4__0");
					...
					put(grammarAccess.getInclAccess().getGroup(), "rule__Incl__Group__0");
					put(grammarAccess.getInclAccess().getGroup_1(), "rule__Incl__Group_1__0");
					put(grammarAccess.getConsListAccess().getGroup(), "rule__ConsList__Group__0");
					put(grammarAccess.getConsListAccess().getGroup_1(), "rule__ConsList__Group_1__0");
					put(grammarAccess.getConsAccess().getGroup_0(), "rule__Cons__Group_0__0");
					put(grammarAccess.getNoEqAccess().getGroup_0(), "rule__NoEq__Group_0__0");
					put(grammarAccess.getNoEqAccess().getGroup_1(), "rule__NoEq__Group_1__0");
					put(grammarAccess.getNoEqAccess().getGroup_2(), "rule__NoEq__Group_2__0");
					put(grammarAccess.getConsPredAccess().getGroup(), "rule__ConsPred__Group__0");
					...
					put(grammarAccess.getPredAccess().getGroup_0(), "rule__Pred__Group_0__0");
					put(grammarAccess.getCompAccess().getGroup(), "rule__Comp__Group__0");
					put(grammarAccess.getCompAccess().getGroup_0_0(), "rule__Comp__Group_0_0__0");
					put(grammarAccess.getCompAccess().getGroup_0_1(), "rule__Comp__Group_0_1__0");
					put(grammarAccess.getCompAccess().getGroup_0_2(), "rule__Comp__Group_0_2__0");
					put(grammarAccess.getObAcAccess().getGroup(), "rule__ObAc__Group__0");
					put(grammarAccess.getObAcAccess().getGroup_1(), "rule__ObAc__Group_1__0");
					...
					put(grammarAccess.getForbMethodAccess().getParametersAssignment_1_2_0(), "rule__ForbMethod__ParametersAssignment_1_2_0");
					put(grammarAccess.getForbMethodAccess().getParametersAssignment_1_2_2_1(), "rule__ForbMethod__ParametersAssignment_1_2_2_1");
					put(grammarAccess.getForbMethodAccess().getRepAssignment_1_4_1(), "rule__ForbMethod__RepAssignment_1_4_1");
					...
					put(grammarAccess.getAggregateAccess().getLabAssignment_2_0(), "rule__Aggregate__LabAssignment_2_0");
					put(grammarAccess.getAggregateAccess().getLabAssignment_2_1_1(), "rule__Aggregate__LabAssignment_2_1_1");
					...
					put(grammarAccess.getConstraintAccess().getConsAssignment_0(), "rule__Constraint__ConsAssignment_0");
					put(grammarAccess.getConstraintAccess().getConsAssignment_1(), "rule__Constraint__ConsAssignment_1");
					put(grammarAccess.getConstraintAccess().getConsAssignment_2_1(), "rule__Constraint__ConsAssignment_2_1");
					put(grammarAccess.getInclAccess().getAlglAssignment_0(), "rule__Incl__AlglAssignment_0");
					put(grammarAccess.getInclAccess().getAlgrAssignment_1_1(), "rule__Incl__AlgrAssignment_1_1");
					put(grammarAccess.getConsListAccess().getListAssignment_0(), "rule__ConsList__ListAssignment_0");
					put(grammarAccess.getConsListAccess().getListAssignment_1_1(), "rule__ConsList__ListAssignment_1_1");
					...
					put(grammarAccess.getNoEqAccess().getLeftAssignment_0_0(), "rule__NoEq__LeftAssignment_0_0");
					put(grammarAccess.getNoEqAccess().getRightAssignment_0_2(), "rule__NoEq__RightAssignment_0_2");
					put(grammarAccess.getNoEqAccess().getLeftAssignment_1_0(), "rule__NoEq__LeftAssignment_1_0");
					put(grammarAccess.getNoEqAccess().getRightAssignment_2_2(), "rule__NoEq__RightAssignment_2_2");
					put(grammarAccess.getConsPredAccess().getNameAssignment_1(), "rule__ConsPred__NameAssignment_1");
					...
					put(grammarAccess.getPredAccess().getLeftSideAssignment_0_0(), "rule__Pred__LeftSideAssignment_0_0");
					put(grammarAccess.getPredAccess().getPredNameAssignment_1(), "rule__Pred__PredNameAssignment_1");
					put(grammarAccess.getPredAccess().getParListAssignment_3(), "rule__Pred__ParListAssignment_3");
					put(grammarAccess.getCompAccess().getLeftAssignment_0_0_0(), "rule__Comp__LeftAssignment_0_0_0");
					put(grammarAccess.getCompAccess().getRightAssignment_0_0_2(), "rule__Comp__RightAssignment_0_0_2");
					put(grammarAccess.getCompAccess().getLeftAssignment_0_1_0(), "rule__Comp__LeftAssignment_0_1_0");
					put(grammarAccess.getCompAccess().getRightAssignment_0_2_2(), "rule__Comp__RightAssignment_0_2_2");
					put(grammarAccess.getObAcAccess().getNameAssignment_0(), "rule__ObAc__NameAssignment_0");
