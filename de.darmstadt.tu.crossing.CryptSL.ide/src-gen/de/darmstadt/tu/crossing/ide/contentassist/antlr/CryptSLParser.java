		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getEventAccess().getGroup_1_2_1(), "rule__Event__Group_1_2_1__0");
					...
					put(grammarAccess.getForbMethodAccess().getGroup_2(), "rule__ForbMethod__Group_2__0");
					put(grammarAccess.getForbMethodAccess().getGroup_2_1(), "rule__ForbMethod__Group_2_1__0");
					put(grammarAccess.getForbMethodAccess().getGroup_4(), "rule__ForbMethod__Group_4__0");
					...
					put(grammarAccess.getDomainmodelAccess().getReqAssignment_12(), "rule__Domainmodel__ReqAssignment_12");
					put(grammarAccess.getEventAccess().getMethodAssignment_0(), "rule__Event__MethodAssignment_0");
					put(grammarAccess.getEventAccess().getAggAssignment_1_0(), "rule__Event__AggAssignment_1_0");
					put(grammarAccess.getEventAccess().getLabAssignment_1_2_0(), "rule__Event__LabAssignment_1_2_0");
					put(grammarAccess.getEventAccess().getLabAssignment_1_2_1_1(), "rule__Event__LabAssignment_1_2_1_1");
					...
					put(grammarAccess.getOrderEvAccess().getMethxAssignment(), "rule__OrderEv__MethxAssignment");
					put(grammarAccess.getMethodAccess().getLabelAssignment_0(), "rule__Method__LabelAssignment_0");
					put(grammarAccess.getMethodAccess().getLeftSideAssignment_2_0(), "rule__Method__LeftSideAssignment_2_0");
					...
					put(grammarAccess.getForbMethodAccess().getParametersAssignment_2_0(), "rule__ForbMethod__ParametersAssignment_2_0");
					put(grammarAccess.getForbMethodAccess().getParametersAssignment_2_1_1(), "rule__ForbMethod__ParametersAssignment_2_1_1");
					put(grammarAccess.getForbMethodAccess().getRepAssignment_4_1(), "rule__ForbMethod__RepAssignment_4_1");
					put(grammarAccess.getObjectDeclAccess().getObjectTypeAssignment_0(), "rule__ObjectDecl__ObjectTypeAssignment_0");
					put(grammarAccess.getObjectDeclAccess().getObjectNameAssignment_1(), "rule__ObjectDecl__ObjectNameAssignment_1");
