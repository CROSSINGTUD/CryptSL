...
@Singleton
public class CrySLGrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	...
	public class ConsPredElements extends AbstractParserRuleElementFinder {
		...
		//(consPred = "alg("lit=LiteralExpression ")"| consPred = "mode("lit=LiteralExpression ")" | consPred = "pad("lit=LiteralExpression ")")
