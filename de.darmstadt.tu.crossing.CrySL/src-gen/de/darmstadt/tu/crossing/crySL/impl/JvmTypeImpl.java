 ...
 * </p>
 * <ul>
 *   <li>{@link de.darmstadt.tu.crossing.crySL.impl.JvmTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class JvmTypeImpl extends MinimalEObjectImpl.Container implements JvmType
{
  ...
  {
    return CrySLPackage.Literals.JVM_TYPE;
  }
    ...
    if (type != null && type.eIsProxy())
    {
      ...
      if (type != oldType)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, CrySLPackage.JVM_TYPE__TYPE, oldType, type));
      }
    }
    return type;
  }
  ...
  public void setType(org.eclipse.xtext.common.types.JvmType newType)
  {
    ...
    type = newType;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CrySLPackage.JVM_TYPE__TYPE, oldType, type));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case CrySLPackage.JVM_TYPE__TYPE:
