package de.darmstadt.tu.crossing.statemachine.diagram.parsers;
...
public class MessageFormatParser extends AbstractAttributeParser {
	...
	public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
		...
		if (values == null) {
			return new ParserEditStatus(StatemachineDiagramEditorPlugin.ID, IParserEditStatus.UNEDITABLE,
