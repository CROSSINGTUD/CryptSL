...
public class StateNameEditPart extends CompartmentEditPart implements
	 ...
	 * @generated
	 */
	public void setLabel(WrappingLabel figure, int nodeIndex) {
		unregisterVisuals();
		setFigure(figure);
		defaultText = getLabelTextHelper(figure);
		registerVisuals();
		refreshVisuals(nodeIndex);
	}
	...
	protected String getLabelText() {
		...
		if (parserElement != null && getParser() != null) {
			...
			/*if(!text.equals("[]")) {
				text = String.valueOf(ordercount);
			...
			parser = StatemachineParserProvider
					.getParser(
							...
							StatemachineVisualIDRegistry
									.getType(de.darmstadt.tu.crossing.statemachine.diagram.edit.parts.StateNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					OrderEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	 ...
	 * @generated
	 */
	protected void refreshVisuals(int nodeIndex) {
		super.refreshVisuals();
		refreshLabel(nodeIndex);
		refreshFont();
		refreshFontColor();
		refreshUnderline();
	 ...
	 * @generated
	 */
	protected void refreshLabel(int nodeIndex) {
		setLabelTextHelper(getFigure(),getLabelText());
		setLabelTextHelper(getFigure(),Integer.toString(nodeIndex));
