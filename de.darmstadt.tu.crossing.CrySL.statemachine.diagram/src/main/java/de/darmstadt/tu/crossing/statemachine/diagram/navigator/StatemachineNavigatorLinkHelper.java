...
public class StatemachineNavigatorLinkHelper implements ILinkHelper {
	...
	public IStructuredSelection findSelection(IEditorInput anInput) {
		IDiagramDocument document = StatemachineDiagramEditorPlugin.getInstance().getDocumentProvider()
		...
		if (file != null) {
			StatemachineNavigatorItem item = new StatemachineNavigatorItem(diagram, file, false);
	...
	public void activateEditor(IWorkbenchPage aPage, IStructuredSelection aSelection) {
		...
		if (abstractNavigatorItem instanceof StatemachineNavigatorItem) {
			navigatorView = ((StatemachineNavigatorItem) abstractNavigatorItem).getView();
			...
			if (navigatorGroup.getParent() instanceof StatemachineNavigatorItem) {
				navigatorView = ((StatemachineNavigatorItem) navigatorGroup.getParent()).getView();
			}
		}
