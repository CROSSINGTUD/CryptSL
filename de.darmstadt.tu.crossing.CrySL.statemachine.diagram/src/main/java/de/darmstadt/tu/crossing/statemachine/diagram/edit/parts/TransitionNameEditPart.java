...
import de.darmstadt.tu.crossing.statemachine.diagram.edit.policies.StatemachineTextSelectionEditPolicy;
...
public class TransitionNameEditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(StatemachineVisualIDRegistry.getType(de.darmstadt.tu.crossing.statemachine.diagram.edit.parts.TransitionNameEditPart.VISUAL_ID), new Point(0, 40));
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new StatemachineTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = StatemachineParserProvider.getParser(StatemachineElementTypes.Transition_4001, getParserElement(),StatemachineVisualIDRegistry
					.getType(de.darmstadt.tu.crossing.statemachine.diagram.edit.parts.TransitionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, OrderEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
