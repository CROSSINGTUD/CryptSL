...
public class StatemachineViewProvider extends AbstractProvider implements
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return OrderEditPart.MODEL_ID.equals(op.getSemanticHint())
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(OrderEditPart.MODEL_ID);
	...
	/*	Connector edge = NotationFactory.eINSTANCE.createConnector();
		...
		edge.setBendpoints(bendpoints);
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(StatemachineVisualIDRegistry.getType(TransitionEditPart.VISUAL_ID));
		edge.setElement(domainElement);
		// initializePreferences
		...
		Node TransitionName_6001 = createLabel(edge, StatemachineVisualIDRegistry.getType(TransitionNameEditPart.VISUAL_ID));
	...
	private void stampShortcut(View containerView, Node target) {
		if (!OrderEditPart.MODEL_ID.equals(StatemachineVisualIDRegistry
				.getModelID(containerView))) {
			EAnnotation shortcutAnnotation = EcoreFactory.eINSTANCE
					.createEAnnotation();
			shortcutAnnotation.setSource("Shortcut"); //$NON-NLS-1$
			shortcutAnnotation.getDetails().put(
					"modelID", OrderEditPart.MODEL_ID); //$NON-NLS-1$
