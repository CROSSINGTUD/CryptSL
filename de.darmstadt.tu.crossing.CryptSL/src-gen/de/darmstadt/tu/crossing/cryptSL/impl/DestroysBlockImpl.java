 ...
 * </p>
 * <ul>
 *   <li>{@link de.darmstadt.tu.crossing.cryptSL.impl.DestroysBlockImpl#getPred <em>Pred</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DestroysBlockImpl extends MinimalEObjectImpl.Container implements DestroysBlock
{
  ...
  {
    return CryptSLPackage.Literals.DESTROYS_BLOCK;
  }
  ...
  public EList<Constraint> getPred()
  {
    if (pred == null)
    {
      pred = new EObjectContainmentEList<Constraint>(Constraint.class, this, CryptSLPackage.DESTROYS_BLOCK__PRED);
    }
    return pred;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CryptSLPackage.DESTROYS_BLOCK__PRED:
