...
public class ComparisonExpressionImpl extends ConstraintImpl implements ComparisonExpression {
	...
	/**
	 * The cached value of the '{@link #getLeft() <em>Left</em>}' containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getLeft()
	 * @generated
	 * @ordered
	...
	public String toString() {
		return ((LiteralExpression) ((LiteralExpression) this.getLeftExpression()).getCons().getName()).getValue().getName() + " " + this.getOperator()
			.toString() + " " + ((LiteralExpression) ((LiteralExpression) this.getRightExpression()).getCons().getName()).getValue().getName();
	}
}