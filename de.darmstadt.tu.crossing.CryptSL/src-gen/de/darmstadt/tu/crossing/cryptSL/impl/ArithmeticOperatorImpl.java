 ...
 *   <li>{@link de.darmstadt.tu.crossing.cryptSL.impl.ArithmeticOperatorImpl#getMOD <em>MOD</em>}</li>
...
public class ArithmeticOperatorImpl extends MinimalEObjectImpl.Container implements ArithmeticOperator
{
  ...
  public void setMOD(String newMOD)
  {
    ...
    mod = newMOD;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CryptSLPackage.ARITHMETIC_OPERATOR__MOD, oldMOD, mod));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case CryptSLPackage.ARITHMETIC_OPERATOR__MINUS:
        return getMINUS();
      case CryptSLPackage.ARITHMETIC_OPERATOR__MOD:
        return getMOD();
