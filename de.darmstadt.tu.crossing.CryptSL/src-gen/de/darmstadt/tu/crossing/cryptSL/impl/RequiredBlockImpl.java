 ...
 * </p>
 * <ul>
 *   <li>{@link de.darmstadt.tu.crossing.cryptSL.impl.RequiredBlockImpl#getReq_event <em>Req event</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RequiredBlockImpl extends MinimalEObjectImpl.Container implements RequiredBlock
{
  ...
  {
    return CryptSLPackage.Literals.REQUIRED_BLOCK;
  }
  ...
  public EList<Event> getReq_event()
  {
    if (req_event == null)
    {
      req_event = new EObjectContainmentEList<Event>(Event.class, this, CryptSLPackage.REQUIRED_BLOCK__REQ_EVENT);
    }
    return req_event;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CryptSLPackage.REQUIRED_BLOCK__REQ_EVENT:
