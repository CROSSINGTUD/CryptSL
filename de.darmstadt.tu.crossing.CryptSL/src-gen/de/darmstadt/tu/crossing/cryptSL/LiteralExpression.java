 ...
 *   <li>{@link de.darmstadt.tu.crossing.cryptSL.LiteralExpression#getConsPred <em>Cons Pred</em>}</li>
...
public interface LiteralExpression extends Constraint
{
   ...
   * @see de.darmstadt.tu.crossing.cryptSL.CryptSLPackage#getLiteralExpression_ConsPred()
   * @model
   * @generated
   */
  String getConsPred();
  ...
  /**
   * Sets the value of the '{@link de.darmstadt.tu.crossing.cryptSL.LiteralExpression#getConsPred <em>Cons Pred</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
